...
**Binding rule — STD-0006 §7.5 (Verification Integrity):** state the strength of your own verification. If you could NOT live-verify a sample of the cited sources/figures against their primaries (e.g. web tools unavailable), mark your review **verification-light**. A verification-light review may still issue Conformant/Flagged verdicts, but it **may not clear an object for external reliance** — reliance is gated pending live re-verification or genuinely independent review. Failing to disclose a weak check is itself a Flag: an undisclosed weak check invites unwarranted confidence.
