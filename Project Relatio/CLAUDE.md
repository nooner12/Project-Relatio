...
- **Investigation closure state (as of 2026-07-20, INV-0014 opening):** **thirteen investigations INV-0001…INV-0013 are formally CLOSED; one open at scaffold — INV-0014 (The Historical Jesus), opened unexecuted per owner-ratified brief, awaiting its OPS-0003 circuit under a separate brief.** INV-0011 — the last of the thirteen — closed 2026-07-21 after an owner-directed sub-question completion circuit met its criterion #2 (explicit, separable (i)/(ii)/(iii) answers in each doctrine claim, CLM-0051…CLM-0055, full OPS-0003 circuit; met at INV-0011 v0.5, not v0.2). "Closed" means the inquiry is complete; it is **not** a maturity promotion (INVs stay `status: Draft`) and **not** a clearance for external reliance.
