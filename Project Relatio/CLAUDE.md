...
- **Investigation closure state (as of 2026-07-20, INV-0015 scaffold opening):** **fourteen investigations INV-0001…INV-0014 are formally CLOSED; one is open at scaffold — INV-0015 (Academic Classification of Yiguandao, Reading C), opened 2026-07-20, unexecuted (zero claims/sources/findings), awaiting its OPS-0003 circuit under a separate brief; §7.5-analog gate declared at opening (verification-light expected; findings not cleared for external reliance regardless of closure).** INV-0014 (The Historical Jesus) executed its full OPS-0003 circuit and closed 2026-07-20 under the owner's conditional pre-authorization (Critical Review – RQ-0014 Conformant with Flags, all determinate flags remediated; no confidence level changed; ROLE-0001 validation in-record at INV-0014 v0.3; Registry v1.26). INV-0011 closed 2026-07-21 after its criterion-#2 sub-question circuit (met at v0.5, not v0.2). "Closed" means the inquiry is complete; it is **not** a maturity promotion (INVs stay `status: Draft`) and **not** a clearance for external reliance — INV-0014's findings in particular remain §7.5-gated (verification-split review; independent re-verification required before thesis-supporting or public use).
