...
**The Governance Backlog is now the single source of open items** (replacing the scattered lists). Deferred-by-decision items (GB-2026-002 quantitative evidence, GB-2026-003 entity template, GB-2026-008 ST-003) live there with their decision status — do not action without demonstrated need or the Vision Steward's approval. *(GB-005 phantom ADRs, GB-2026-007 KOS-0200 fate, GB-2026-006 two-dimensional lifecycle field, GB-2026-001 typed relationships, GB-2026-031 INV closure convention, and GB-2026-028 version-vs-history drift are now resolved — see the Backlog §3.)* Note that GB-2026-028 closed on **remediation**, not prevention: the durable `validate.py` coherence check is still unbuilt and is carried forward as **GB-2026-035**.
